...
- Replace `<your_account>` with your Github username in the  and add it [DEMO LINK](https://VikaChereushenko.github.io/react_static-list-of-posts-js/)to the PR description.
